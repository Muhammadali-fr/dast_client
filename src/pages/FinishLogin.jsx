...
const FinishLogin = ({ preview, formData, prevStep, handleRegister }) => {
    return (
        <>
            <div className="flex items-center justify-center h-[95vh]">
                ...
                <div className="w-[283px] flex flex-col gap-3">
                    ...
                    {/* Button  */}
                    <button onClick={handleRegister} className="w-full py-3 rounded-lg bg-linear-to-b from-[#4A249D] to-[#7D41FF] text-white mt-2 cursor-pointer hover:opacity-90">FINISH & LOGIN</button>
